...
const { logFormat } = require('../utils/logFormat');
const getTransportsForEnv = require('../utils/transports');

/**
 * This is the one fleet logger wrapped around Winston's createLogger
...
const Logger = (options = {}) => {
  const {
    ...
    app_name = (process.env.APP_NAME || 'APP_UNKNOWN'), // eslint-disable-line camelcase
    level = 'info',
  } = options;
